...
class SecurityIntegrationTests {
    ...
    @Test
    void missingEmailLoginReturnsUnauthorized() throws Exception {
    ...
    @Test
    void blankCredentialsLoginReturnsUnauthorized() throws Exception {
    ...
    @Test
    void nullCredentialsLoginReturnsUnauthorized() throws Exception {
